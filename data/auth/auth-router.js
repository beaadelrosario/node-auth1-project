...
//         const hash = bcryptjs.hashSync(userInfo.password, rounds); // grab the password before saving user to db
...
//     } else {
//         res.status(400).json({
//             message: "Invalid information, pleae verify and try again",
//         });
//     }
// });
